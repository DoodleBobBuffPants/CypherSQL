...
public class CypherParser extends Parser {
	...
	public static final int
		...
		T__6=39, T__5=40, T__4=41, T__3=42, T__2=43, T__1=44, T__0=45, UNION=46, 
		ALL=47, OPTIONAL=48, MATCH=49, UNWIND=50, AS=51, MERGE=52, ON=53, CREATE=54, 
		SET=55, DETACH=56, DELETE=57, REMOVE=58, CALL=59, YIELD=60, WITH=61, DISTINCT=62, 
		RETURN=63, ORDER=64, BY=65, L_SKIP=66, LIMIT=67, ASCENDING=68, ASC=69, 
		DESCENDING=70, DESC=71, WHERE=72, OR=73, XOR=74, AND=75, NOT=76, IN=77, 
		STARTS=78, ENDS=79, CONTAINS=80, IS=81, NULL=82, COUNT=83, ANY=84, NONE=85, 
		SINGLE=86, TRUE=87, FALSE=88, EXISTS=89, CASE=90, ELSE=91, END=92, WHEN=93, 
		THEN=94, StringLiteral=95, EscapedChar=96, HexInteger=97, DecimalInteger=98, 
		...
		EXTRACT=120, ALLSHORTESTPATHS=121, UnescapedSymbolicName=122, IdentifierStart=123, 
	...
	public static final String[] tokenNames = {
		...
		"OctDigit", "'0'", "ExponentDecimalReal", "RegularDecimalReal", "CONSTRAINT", 
		"DO", "FOR", "REQUIRE", "UNIQUE", "MANDATORY", "SCALAR", "OF", "ADD", 
		"DROP", "FILTER", "EXTRACT", "ALLSHORTESTPATHS", "UnescapedSymbolicName", 
	...
	public final OC_CypherContext oC_Cypher() throws RecognitionException {
		...
		try {
			...
			if (_la==SP) {
				{
				setState(198); match(SP);
				}
			}

			setState(201); oC_Statement();
			setState(206);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(202); match(SP);
					}
				}

				setState(205); match(T__35);
				}
				break;
			}
			setState(209);
	...
	public final OC_QueryContext oC_Query() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(215); oC_RegularQuery();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(216); oC_StandaloneCall();
				}
				break;
			}
		}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(220); match(SP);
						}
					}

					setState(223); oC_Union();
					}
					} 
				}
				setState(228);
	...
	public final OC_UnionContext oC_Union() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(229); match(UNION);
				setState(230); match(SP);
				setState(231); match(ALL);
				setState(233);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(232); match(SP);
					}
				}

				setState(235); oC_SingleQuery();
				}
				}
				break;
			case 2:
				...
				{
				{
				setState(236); match(UNION);
				setState(238);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(237); match(SP);
					}
				}

				setState(240); oC_SingleQuery();
				}
				}
				break;
			}
	...
	public final OC_SingleQueryContext oC_SingleQuery() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(243); oC_SinglePartQuery();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(244); oC_MultiPartQuery();
				}
				break;
			}
		}
		...
		try {
			...
			case 1:
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << OPTIONAL) | (1L << MATCH) | (1L << UNWIND) | (1L << CALL))) != 0)) {
					{
					{
					setState(247); oC_ReadingClause();
					setState(249);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(248); match(SP);
						}
					}
			...
			case 2:
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << OPTIONAL) | (1L << MATCH) | (1L << UNWIND) | (1L << CALL))) != 0)) {
					{
					{
					setState(257); oC_ReadingClause();
					setState(259);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(258); match(SP);
						}
					}
				...
				setState(266); oC_UpdatingClause();
				setState(273);
				_errHandler.sync(this);
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						if (_la==SP) {
							{
							setState(267); match(SP);
							}
						}

						setState(270); oC_UpdatingClause();
						}
						} 
					}
					setState(275);
				...
				case 1:
					...
					if (_la==SP) {
						{
						setState(276); match(SP);
						}
					}

					setState(279); oC_Return();
					}
					break;
				}
				}
	...
	public final OC_MultiPartQueryContext oC_MultiPartQuery() throws RecognitionException {
		...
		try {
			...
			do {
				...
				case 1:
					...
					while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << OPTIONAL) | (1L << MATCH) | (1L << UNWIND) | (1L << CALL))) != 0)) {
						{
						{
						setState(284); oC_ReadingClause();
						setState(286);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(285); match(SP);
							}
						}
					...
					while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << MERGE) | (1L << CREATE) | (1L << SET) | (1L << DETACH) | (1L << DELETE) | (1L << REMOVE))) != 0)) {
						{
						{
						setState(293); oC_UpdatingClause();
						setState(295);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(294); match(SP);
							}
						}
					...
					setState(302); oC_With();
					setState(304);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(303); match(SP);
						}
					}
			...
			setState(310); oC_SinglePartQuery();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_UpdatingClauseContext oC_UpdatingClause() throws RecognitionException {
		...
		try {
			...
			case CREATE:
				enterOuterAlt(_localctx, 1);
				{
				setState(312); oC_Create();
				}
				break;
			case MERGE:
				enterOuterAlt(_localctx, 2);
				{
				setState(313); oC_Merge();
				}
				break;
			case DETACH:
			case DELETE:
	...
	public final OC_ReadingClauseContext oC_ReadingClause() throws RecognitionException {
		...
		try {
			...
			case MATCH:
				enterOuterAlt(_localctx, 1);
				{
				setState(319); oC_Match();
				}
				break;
			case UNWIND:
				enterOuterAlt(_localctx, 2);
				{
				setState(320); oC_Unwind();
				}
				break;
			case CALL:
				enterOuterAlt(_localctx, 3);
				{
				setState(321); oC_InQueryCall();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final OC_MatchContext oC_Match() throws RecognitionException {
		...
		try {
			...
			if (_la==OPTIONAL) {
				{
				setState(324); match(OPTIONAL);
				setState(325); match(SP);
				}
			}

			setState(328); match(MATCH);
			setState(330);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(329); match(SP);
				}
			}

			setState(332); oC_Pattern();
			setState(337);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(333); match(SP);
					}
				}

				setState(336); oC_Where();
				}
				break;
			}
			}
	...
	public final OC_UnwindContext oC_Unwind() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(339); match(UNWIND);
			setState(341);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(340); match(SP);
				}
			}

			setState(343); oC_Expression();
			setState(344); match(SP);
			setState(345); match(AS);
			setState(346); match(SP);
			setState(347); oC_Variable();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_MergeContext oC_Merge() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(349); match(MERGE);
			setState(351);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(350); match(SP);
				}
			}

			setState(353); oC_PatternPart();
			setState(358);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(354); match(SP);
					setState(355); oC_MergeAction();
					}
					} 
				}
				setState(360);
	...
	public final OC_MergeActionContext oC_MergeAction() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(361); match(ON);
				setState(362); match(SP);
				setState(363); match(MATCH);
				setState(364); match(SP);
				setState(365); oC_Set();
				}
				}
				break;
			case 2:
				...
				{
				{
				setState(366); match(ON);
				setState(367); match(SP);
				setState(368); match(CREATE);
				setState(369); match(SP);
				setState(370); oC_Set();
				}
				}
				break;
	...
	public final OC_CreateContext oC_Create() throws RecognitionException {
		...
		try {
			...
			if (_la==SP) {
				{
				setState(374); match(SP);
				}
			}

			setState(377); oC_Pattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_SetContext oC_Set() throws RecognitionException {
		...
		try {
			...
			if (_la==SP) {
				{
				setState(380); match(SP);
				}
			}

			setState(383); oC_SetItem();
			setState(388);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__21) {
				{
				{
				setState(384); match(T__21);
				setState(385); oC_SetItem();
				}
				}
				setState(390);
				_errHandler.sync(this);
	...
	public final OC_SetItemContext oC_SetItem() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(391); oC_PropertyExpression();
				setState(393);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(392); match(SP);
					}
				}
				...
				if (_la==SP) {
					{
					setState(396); match(SP);
					}
				}

				setState(399); oC_Expression();
				}
				}
				break;
			case 2:
				...
				{
				{
				setState(401); oC_Variable();
				setState(403);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(402); match(SP);
					}
				}
				...
				if (_la==SP) {
					{
					setState(406); match(SP);
					}
				}

				setState(409); oC_Expression();
				}
				}
				break;
			case 3:
				...
				{
				{
				setState(411); oC_Variable();
				setState(413);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(412); match(SP);
					}
				}

				setState(415); match(T__41);
				setState(417);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(416); match(SP);
					}
				}

				setState(419); oC_Expression();
				}
				}
				break;
			case 4:
				...
				{
				{
				setState(421); oC_Variable();
				setState(423);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(422); match(SP);
					}
				}

				setState(425); oC_NodeLabels();
				}
				}
				break;
			}
	...
	public final OC_DeleteContext oC_Delete() throws RecognitionException {
		...
		try {
			...
			if (_la==DETACH) {
				{
				setState(429); match(DETACH);
				setState(430); match(SP);
				}
			}

			setState(433); match(DELETE);
			setState(435);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(434); match(SP);
				}
			}

			setState(437); oC_Expression();
			setState(448);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(438); match(SP);
						}
					}

					setState(441); match(T__21);
					setState(443);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(442); match(SP);
						}
					}

					setState(445); oC_Expression();
					}
					} 
				}
				setState(450);
	...
	public final OC_RemoveContext oC_Remove() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(451); match(REMOVE);
			setState(452); match(SP);
			setState(453); oC_RemoveItem();
			setState(464);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(454); match(SP);
						}
					}

					setState(457); match(T__21);
					setState(459);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(458); match(SP);
						}
					}

					setState(461); oC_RemoveItem();
					}
					} 
				}
				setState(466);
	...
	public final OC_RemoveItemContext oC_RemoveItem() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(467); oC_Variable();
				setState(468); oC_NodeLabels();
				}
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(470); oC_PropertyExpression();
				}
				break;
			}
		}
	...
	public final OC_InQueryCallContext oC_InQueryCall() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(473); match(CALL);
			setState(474); match(SP);
			setState(475); oC_ExplicitProcedureInvocation();
			setState(482);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(476); match(SP);
					}
				}

				setState(479); match(YIELD);
				setState(480); match(SP);
				setState(481); oC_YieldItems();
				}
				break;
			}
			}
	...
	public final OC_StandaloneCallContext oC_StandaloneCall() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(484); match(CALL);
			setState(485); match(SP);
			setState(488);
			switch ( getInterpreter().adaptivePredict(_input,58,_ctx) ) {
			case 1:
				{
				setState(486); oC_ExplicitProcedureInvocation();
				}
				break;
			case 2:
				{
				setState(487); oC_ImplicitProcedureInvocation();
				}
				break;
			}
			setState(494);
			...
			case 1:
				{
				setState(490); match(SP);
				setState(491); match(YIELD);
				setState(492); match(SP);
				setState(493); oC_YieldItems();
				}
				break;
			}
			}
	...
	public final OC_YieldItemsContext oC_YieldItems() throws RecognitionException {
		...
		try {
			...
			case EscapedSymbolicName:
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						if (_la==SP) {
							{
							setState(498); match(SP);
							}
						}

						setState(501); match(T__21);
						setState(503);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(502); match(SP);
							}
						}

						setState(505); oC_YieldItem();
						}
						} 
					}
					setState(510);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(513); match(SP);
					}
				}

				setState(516); oC_Where();
				}
				break;
			}
			}
	...
	public final OC_YieldItemContext oC_YieldItem() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(519); oC_ProcedureResultField();
				setState(520); match(SP);
				setState(521); match(AS);
				setState(522); match(SP);
				}
				break;
			}
			setState(526); oC_Variable();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_WithContext oC_With() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(529); match(SP);
					}
				}

				setState(532); match(DISTINCT);
				}
				break;
			}
			setState(535); match(SP);
			setState(536); oC_ReturnBody();
			setState(541);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(537); match(SP);
					}
				}

				setState(540); oC_Where();
				}
				break;
			}
			}
	...
	public final OC_ReturnContext oC_Return() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(544); match(SP);
					}
				}

				setState(547); match(DISTINCT);
				}
				break;
			}
			setState(550); match(SP);
			setState(551); oC_ReturnBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_ReturnBodyContext oC_ReturnBody() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(553); oC_ReturnItems();
			setState(556);
			switch ( getInterpreter().adaptivePredict(_input,73,_ctx) ) {
			case 1:
				{
				setState(554); match(SP);
				setState(555); oC_Order();
				}
				break;
			}
			setState(560);
			...
			case 1:
				{
				setState(558); match(SP);
				setState(559); oC_Skip();
				}
				break;
			}
			setState(564);
			...
			case 1:
				{
				setState(562); match(SP);
				setState(563); oC_Limit();
				}
				break;
			}
			}
			...
			case T__24:
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						if (_la==SP) {
							{
							setState(571); match(SP);
							}
						}

						setState(574); oC_ReturnItem();
						}
						} 
					}
					setState(579);
			...
			case EscapedSymbolicName:
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						if (_la==SP) {
							{
							setState(585); match(SP);
							}
						}

						setState(588); oC_ReturnItem();
						}
						} 
					}
					setState(593);
	...
	public final OC_ReturnItemContext oC_ReturnItem() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(596); oC_Expression();
				setState(597); match(SP);
				setState(598); match(AS);
				setState(599); match(SP);
				setState(600); oC_Variable();
				}
				}
				break;
			case 2:
	...
	public final OC_OrderContext oC_Order() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(605); match(ORDER);
			setState(606); match(SP);
			setState(607); match(BY);
			setState(608); match(SP);
			setState(609); oC_SortItem();
			setState(617);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__21) {
				{
				{
				setState(610); match(T__21);
				setState(612);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(611); match(SP);
					}
				}

				setState(614); oC_SortItem();
				}
				}
				setState(619);
				_errHandler.sync(this);
	...
	public final OC_SkipContext oC_Skip() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(620); match(L_SKIP);
			setState(621); match(SP);
			setState(622); oC_Expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_LimitContext oC_Limit() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(624); match(LIMIT);
			setState(625); match(SP);
			setState(626); oC_Expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_WhereContext oC_Where() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(635); match(WHERE);
			setState(636); match(SP);
			setState(637); oC_Expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(640); match(SP);
						}
					}

					setState(643); match(T__21);
					setState(645);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(644); match(SP);
						}
					}

					setState(647); oC_PatternPart();
					}
					} 
				}
				setState(652);
	...
	public final OC_PatternPartContext oC_PatternPart() throws RecognitionException {
		...
		try {
			...
			case EscapedSymbolicName:
				...
				{
				{
				setState(653); oC_Variable();
				setState(655);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(654); match(SP);
					}
				}
				...
				if (_la==SP) {
					{
					setState(658); match(SP);
					}
				}

				setState(661); oC_AnonymousPatternPart();
				}
				}
				break;
			case T__25:
				enterOuterAlt(_localctx, 2);
				{
				setState(663); oC_AnonymousPatternPart();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final OC_AnonymousPatternPartContext oC_AnonymousPatternPart() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(666); oC_PatternElement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_PatternElementContext oC_PatternElement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						if (_la==SP) {
							{
							setState(669); match(SP);
							}
						}

						setState(672); oC_PatternElementChain();
						}
						} 
					}
					setState(677);
			...
			case 2:
				...
				{
				{
				setState(678); match(T__25);
				setState(679); oC_PatternElement();
	...
	public final OC_NodePatternContext oC_NodePattern() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(684); match(T__25);
			setState(686);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(685); match(SP);
				}
			}

			setState(692);
			_la = _input.LA(1);
			if (((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & ((1L << (COUNT - 83)) | (1L << (ANY - 83)) | (1L << (NONE - 83)) | (1L << (SINGLE - 83)) | (1L << (HexLetter - 83)) | (1L << (FILTER - 83)) | (1L << (EXTRACT - 83)) | (1L << (ALLSHORTESTPATHS - 83)) | (1L << (UnescapedSymbolicName - 83)) | (1L << (EscapedSymbolicName - 83)))) != 0)) {
				{
				setState(688); oC_Variable();
				setState(690);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(689); match(SP);
					}
				}
			...
			if (_la==T__14) {
				{
				setState(694); oC_NodeLabels();
				setState(696);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(695); match(SP);
					}
				}
			...
			setState(704);
			_la = _input.LA(1);
			if (_la==T__36 || _la==T__27) {
				{
				setState(700); oC_Properties();
				setState(702);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(701); match(SP);
					}
				}
	...
	public final OC_PatternElementChainContext oC_PatternElementChain() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(708); oC_RelationshipPattern();
			setState(710);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(709); match(SP);
				}
			}

			setState(712); oC_NodePattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_RelationshipPatternContext oC_RelationshipPattern() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(714); oC_LeftArrowHead();
				setState(716);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(715); match(SP);
					}
				}

				setState(718); oC_Dash();
				setState(720);
				switch ( getInterpreter().adaptivePredict(_input,106,_ctx) ) {
				case 1:
					{
					setState(719); match(SP);
					}
					break;
				}
				setState(723);
				...
				if (_la==T__12) {
					{
					setState(722); oC_RelationshipDetail();
					}
				}
				...
				if (_la==SP) {
					{
					setState(725); match(SP);
					}
				}

				setState(728); oC_Dash();
				setState(730);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(729); match(SP);
					}
				}

				setState(732); oC_RightArrowHead();
				}
				}
				break;
			case 2:
				...
				{
				{
				setState(734); oC_LeftArrowHead();
				setState(736);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(735); match(SP);
					}
				}

				setState(738); oC_Dash();
				setState(740);
				switch ( getInterpreter().adaptivePredict(_input,111,_ctx) ) {
				case 1:
					{
					setState(739); match(SP);
					}
					break;
				}
				setState(743);
				...
				if (_la==T__12) {
					{
					setState(742); oC_RelationshipDetail();
					}
				}
				...
				if (_la==SP) {
					{
					setState(745); match(SP);
					}
				}

				setState(748); oC_Dash();
				}
				}
				break;
			case 3:
				...
				{
				{
				setState(750); oC_Dash();
				setState(752);
				switch ( getInterpreter().adaptivePredict(_input,114,_ctx) ) {
				case 1:
					{
					setState(751); match(SP);
					}
					break;
				}
				setState(755);
				...
				if (_la==T__12) {
					{
					setState(754); oC_RelationshipDetail();
					}
				}
				...
				if (_la==SP) {
					{
					setState(757); match(SP);
					}
				}

				setState(760); oC_Dash();
				setState(762);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(761); match(SP);
					}
				}

				setState(764); oC_RightArrowHead();
				}
				}
				break;
			case 4:
				...
				{
				{
				setState(766); oC_Dash();
				setState(768);
				switch ( getInterpreter().adaptivePredict(_input,118,_ctx) ) {
				case 1:
					{
					setState(767); match(SP);
					}
					break;
				}
				setState(771);
				...
				if (_la==T__12) {
					{
					setState(770); oC_RelationshipDetail();
					}
				}
				...
				if (_la==SP) {
					{
					setState(773); match(SP);
					}
				}

				setState(776); oC_Dash();
				}
				}
				break;
			}
	...
	public final OC_RelationshipDetailContext oC_RelationshipDetail() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(780); match(T__12);
			setState(782);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(781); match(SP);
				}
			}
			...
			if (((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & ((1L << (COUNT - 83)) | (1L << (ANY - 83)) | (1L << (NONE - 83)) | (1L << (SINGLE - 83)) | (1L << (HexLetter - 83)) | (1L << (FILTER - 83)) | (1L << (EXTRACT - 83)) | (1L << (ALLSHORTESTPATHS - 83)) | (1L << (UnescapedSymbolicName - 83)) | (1L << (EscapedSymbolicName - 83)))) != 0)) {
				{
				setState(784); oC_Variable();
				setState(786);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(785); match(SP);
					}
				}
			...
			if (_la==T__14) {
				{
				setState(790); oC_RelationshipTypes();
				setState(792);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(791); match(SP);
					}
				}
			...
			if (_la==T__36 || _la==T__27) {
				{
				setState(799); oC_Properties();
				setState(801);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(800); match(SP);
					}
				}
	...
	public final OC_PropertiesContext oC_Properties() throws RecognitionException {
		...
		try {
			...
			case T__36:
				enterOuterAlt(_localctx, 1);
				{
				setState(807); oC_MapLiteral();
				}
				break;
			case T__27:
				enterOuterAlt(_localctx, 2);
				{
				setState(808); oC_Parameter();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final OC_RelationshipTypesContext oC_RelationshipTypes() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(811); match(T__14);
			setState(813);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(812); match(SP);
				}
			}

			setState(815); oC_RelTypeName();
			setState(829);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(816); match(SP);
						}
					}

					setState(819); match(T__10);
					setState(821);
					_la = _input.LA(1);
					if (_la==T__14) {
						{
						setState(820); match(T__14);
						}
					}
					...
					if (_la==SP) {
						{
						setState(823); match(SP);
						}
					}

					setState(826); oC_RelTypeName();
					}
					} 
				}
				setState(831);
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(833); match(SP);
						}
					}

					setState(836); oC_NodeLabel();
					}
					} 
				}
				setState(841);
	...
	public final OC_NodeLabelContext oC_NodeLabel() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(842); match(T__14);
			setState(844);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(843); match(SP);
				}
			}

			setState(846); oC_LabelName();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_RangeLiteralContext oC_RangeLiteral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(848); match(T__24);
			setState(850);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(849); match(SP);
				}
			}
			...
			if (((((_la - 97)) & ~0x3f) == 0 && ((1L << (_la - 97)) & ((1L << (HexInteger - 97)) | (1L << (DecimalInteger - 97)) | (1L << (OctalInteger - 97)))) != 0)) {
				{
				setState(852); oC_IntegerLiteral();
				setState(854);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(853); match(SP);
					}
				}
			...
			if (_la==T__34) {
				{
				setState(858); match(T__34);
				setState(860);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(859); match(SP);
					}
				}
				...
				if (((((_la - 97)) & ~0x3f) == 0 && ((1L << (_la - 97)) & ((1L << (HexInteger - 97)) | (1L << (DecimalInteger - 97)) | (1L << (OctalInteger - 97)))) != 0)) {
					{
					setState(862); oC_IntegerLiteral();
					setState(864);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(863); match(SP);
						}
					}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(877); match(SP);
					setState(878); match(OR);
					setState(879); match(SP);
					setState(880); oC_XorExpression();
					}
					} 
				}
				setState(885);
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(887); match(SP);
					setState(888); match(XOR);
					setState(889); match(SP);
					setState(890); oC_AndExpression();
					}
					} 
				}
				setState(895);
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(897); match(SP);
					setState(898); match(AND);
					setState(899); match(SP);
					setState(900); oC_NotExpression();
					}
					} 
				}
				setState(905);
	...
	public final OC_NotExpressionContext oC_NotExpression() throws RecognitionException {
		...
		try {
			...
			while (_la==NOT) {
				{
				{
				setState(906); match(NOT);
				setState(908);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(907); match(SP);
					}
				}
			...
			setState(915); oC_ComparisonExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_ComparisonExpressionContext oC_ComparisonExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(917); oC_AddOrSubtractExpression();
			setState(924);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(918); match(SP);
						}
					}

					setState(921); oC_PartialComparisonExpression();
					}
					} 
				}
				setState(926);
	...
	public final OC_AddOrSubtractExpressionContext oC_AddOrSubtractExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(927); oC_MultiplyDivideModuloExpression();
			setState(946);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						if (_la==SP) {
							{
							setState(928); match(SP);
							}
						}

						setState(931); match(T__4);
						setState(933);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(932); match(SP);
							}
						}

						setState(935); oC_MultiplyDivideModuloExpression();
						}
						}
						break;
					case 2:
						...
						if (_la==SP) {
							{
							setState(936); match(SP);
							}
						}

						setState(939); match(T__2);
						setState(941);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(940); match(SP);
							}
						}

						setState(943); oC_MultiplyDivideModuloExpression();
						}
						}
						break;
					}
	...
	public final OC_MultiplyDivideModuloExpressionContext oC_MultiplyDivideModuloExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(949); oC_PowerOfExpression();
			setState(976);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						if (_la==SP) {
							{
							setState(950); match(SP);
							}
						}

						setState(953); match(T__24);
						setState(955);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(954); match(SP);
							}
						}

						setState(957); oC_PowerOfExpression();
						}
						}
						break;
					case 2:
						...
						if (_la==SP) {
							{
							setState(958); match(SP);
							}
						}

						setState(961); match(T__44);
						setState(963);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(962); match(SP);
							}
						}

						setState(965); oC_PowerOfExpression();
						}
						}
						break;
					case 3:
						...
						if (_la==SP) {
							{
							setState(966); match(SP);
							}
						}

						setState(969); match(T__6);
						setState(971);
						_la = _input.LA(1);
						if (_la==SP) {
							{
							setState(970); match(SP);
							}
						}

						setState(973); oC_PowerOfExpression();
						}
						}
						break;
					}
	...
	public final OC_PowerOfExpressionContext oC_PowerOfExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(979); oC_UnaryAddOrSubtractExpression();
			setState(990);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(980); match(SP);
						}
					}

					setState(983); match(T__31);
					setState(985);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(984); match(SP);
						}
					}

					setState(987); oC_UnaryAddOrSubtractExpression();
					}
					} 
				}
				setState(992);
	...
	public final OC_UnaryAddOrSubtractExpressionContext oC_UnaryAddOrSubtractExpression() throws RecognitionException {
		...
		try {
			...
			setState(1002); oC_StringListNullOperatorExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_StringListNullOperatorExpressionContext oC_StringListNullOperatorExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(1004); oC_PropertyOrLabelsExpression();
			setState(1010);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						setState(1005); oC_StringOperatorExpression();
						}
						break;
					case 2:
						{
						setState(1006); oC_ListOperatorExpression();
						}
						break;
					case 3:
						{
						setState(1007); oC_NullOperatorExpression();
						}
						break;
					}
					} 
	...
	public final OC_ListOperatorExpressionContext oC_ListOperatorExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(1013); match(SP);
				setState(1014); match(IN);
				setState(1016);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1015); match(SP);
					}
				}

				setState(1018); oC_PropertyOrLabelsExpression();
				}
				}
				break;
			case 2:
				...
				if (_la==SP) {
					{
					setState(1019); match(SP);
					}
				}

				setState(1022); match(T__12);
				setState(1023); oC_Expression();
				setState(1024); match(T__9);
				}
				}
				break;
			case 3:
				...
				if (_la==SP) {
					{
					setState(1026); match(SP);
					}
				}

				setState(1029); match(T__12);
				setState(1031);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__36) | (1L << T__27) | (1L << T__25) | (1L << T__12) | (1L << T__4) | (1L << T__2) | (1L << ALL))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (NOT - 76)) | (1L << (NULL - 76)) | (1L << (COUNT - 76)) | (1L << (ANY - 76)) | (1L << (NONE - 76)) | (1L << (SINGLE - 76)) | (1L << (TRUE - 76)) | (1L << (FALSE - 76)) | (1L << (EXISTS - 76)) | (1L << (CASE - 76)) | (1L << (StringLiteral - 76)) | (1L << (HexInteger - 76)) | (1L << (DecimalInteger - 76)) | (1L << (OctalInteger - 76)) | (1L << (HexLetter - 76)) | (1L << (ExponentDecimalReal - 76)) | (1L << (RegularDecimalReal - 76)) | (1L << (FILTER - 76)) | (1L << (EXTRACT - 76)) | (1L << (ALLSHORTESTPATHS - 76)) | (1L << (UnescapedSymbolicName - 76)) | (1L << (EscapedSymbolicName - 76)))) != 0)) {
					{
					setState(1030); oC_Expression();
					}
				}

				setState(1033); match(T__34);
				setState(1035);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__36) | (1L << T__27) | (1L << T__25) | (1L << T__12) | (1L << T__4) | (1L << T__2) | (1L << ALL))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (NOT - 76)) | (1L << (NULL - 76)) | (1L << (COUNT - 76)) | (1L << (ANY - 76)) | (1L << (NONE - 76)) | (1L << (SINGLE - 76)) | (1L << (TRUE - 76)) | (1L << (FALSE - 76)) | (1L << (EXISTS - 76)) | (1L << (CASE - 76)) | (1L << (StringLiteral - 76)) | (1L << (HexInteger - 76)) | (1L << (DecimalInteger - 76)) | (1L << (OctalInteger - 76)) | (1L << (HexLetter - 76)) | (1L << (ExponentDecimalReal - 76)) | (1L << (RegularDecimalReal - 76)) | (1L << (FILTER - 76)) | (1L << (EXTRACT - 76)) | (1L << (ALLSHORTESTPATHS - 76)) | (1L << (UnescapedSymbolicName - 76)) | (1L << (EscapedSymbolicName - 76)))) != 0)) {
					{
					setState(1034); oC_Expression();
					}
				}

				setState(1037); match(T__9);
				}
				}
				break;
			}
	...
	public final OC_StringOperatorExpressionContext oC_StringOperatorExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				{
				setState(1040); match(SP);
				setState(1041); match(STARTS);
				setState(1042); match(SP);
				setState(1043); match(WITH);
				}
				}
				break;
			case 2:
				{
				{
				setState(1044); match(SP);
				setState(1045); match(ENDS);
				setState(1046); match(SP);
				setState(1047); match(WITH);
				}
				}
				break;
			case 3:
				{
				{
				setState(1048); match(SP);
				setState(1049); match(CONTAINS);
				}
				}
				break;
			}
			...
			if (_la==SP) {
				{
				setState(1052); match(SP);
				}
			}

			setState(1055); oC_PropertyOrLabelsExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_NullOperatorExpressionContext oC_NullOperatorExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(1057); match(SP);
				setState(1058); match(IS);
				setState(1059); match(SP);
				setState(1060); match(NULL);
				}
				}
				break;
			case 2:
				...
				{
				{
				setState(1061); match(SP);
				setState(1062); match(IS);
				setState(1063); match(SP);
				setState(1064); match(NOT);
				setState(1065); match(SP);
				setState(1066); match(NULL);
				}
				}
				break;
			}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==SP) {
						{
						setState(1070); match(SP);
						}
					}

					setState(1073); oC_PropertyLookup();
					}
					} 
				}
				setState(1078);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(1079); match(SP);
					}
				}

				setState(1082); oC_NodeLabels();
				}
				break;
			}
			}
	...
	public final OC_AtomContext oC_Atom() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1085); oC_Literal();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1086); oC_Parameter();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1087); oC_CaseExpression();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				{
				setState(1088); match(COUNT);
				setState(1090);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1089); match(SP);
					}
				}
				...
				if (_la==SP) {
					{
					setState(1093); match(SP);
					}
				}

				setState(1096); match(T__24);
				setState(1098);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1097); match(SP);
					}
				}

				setState(1100); match(T__5);
				}
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(1101); oC_ListComprehension();
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(1102); oC_PatternComprehension();
				}
				break;
			case 7:
				...
				if (_la==SP) {
					{
					setState(1104); match(SP);
					}
				}

				setState(1107); match(T__25);
				setState(1109);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1108); match(SP);
					}
				}

				setState(1111); oC_FilterExpression();
				setState(1113);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1112); match(SP);
					}
				}

				setState(1115); match(T__5);
				}
				}
				break;
			case 8:
				...
				{
				{
				setState(1117); match(ANY);
				setState(1119);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1118); match(SP);
					}
				}

				setState(1121); match(T__25);
				setState(1123);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1122); match(SP);
					}
				}

				setState(1125); oC_FilterExpression();
				setState(1127);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1126); match(SP);
					}
				}

				setState(1129); match(T__5);
				}
				}
				break;
			case 9:
				...
				{
				{
				setState(1131); match(NONE);
				setState(1133);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1132); match(SP);
					}
				}

				setState(1135); match(T__25);
				setState(1137);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1136); match(SP);
					}
				}

				setState(1139); oC_FilterExpression();
				setState(1141);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1140); match(SP);
					}
				}

				setState(1143); match(T__5);
				}
				}
				break;
			case 10:
				...
				{
				{
				setState(1145); match(SINGLE);
				setState(1147);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1146); match(SP);
					}
				}

				setState(1149); match(T__25);
				setState(1151);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1150); match(SP);
					}
				}

				setState(1153); oC_FilterExpression();
				setState(1155);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1154); match(SP);
					}
				}
			...
			case 11:
				...
				{
				setState(1159); oC_RelationshipsPattern();
				}
				break;
			case 12:
				enterOuterAlt(_localctx, 12);
				{
				setState(1160); oC_ParenthesizedExpression();
				}
				break;
			case 13:
				enterOuterAlt(_localctx, 13);
				{
				setState(1161); oC_FunctionInvocation();
				}
				break;
			case 14:
				enterOuterAlt(_localctx, 14);
				{
				setState(1162); oC_Variable();
				}
				break;
			}
		}
	...
	public final OC_LiteralContext oC_Literal() throws RecognitionException {
		...
		try {
			...
			case RegularDecimalReal:
				enterOuterAlt(_localctx, 1);
				{
				setState(1165); oC_NumberLiteral();
				}
				break;
			case StringLiteral:
				enterOuterAlt(_localctx, 2);
				{
				setState(1166); match(StringLiteral);
				}
				break;
			case TRUE:
			case FALSE:
				enterOuterAlt(_localctx, 3);
				{
				setState(1167); oC_BooleanLiteral();
				}
				break;
			case NULL:
				enterOuterAlt(_localctx, 4);
				{
				setState(1168); match(NULL);
				}
				break;
			case T__36:
				enterOuterAlt(_localctx, 5);
				{
				setState(1169); oC_MapLiteral();
				}
				break;
			case T__12:
				enterOuterAlt(_localctx, 6);
				{
				setState(1170); oC_ListLiteral();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final OC_ListLiteralContext oC_ListLiteral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1175); match(T__12);
			setState(1177);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1176); match(SP);
				}
			}
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__36) | (1L << T__27) | (1L << T__25) | (1L << T__12) | (1L << T__4) | (1L << T__2) | (1L << ALL))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (NOT - 76)) | (1L << (NULL - 76)) | (1L << (COUNT - 76)) | (1L << (ANY - 76)) | (1L << (NONE - 76)) | (1L << (SINGLE - 76)) | (1L << (TRUE - 76)) | (1L << (FALSE - 76)) | (1L << (EXISTS - 76)) | (1L << (CASE - 76)) | (1L << (StringLiteral - 76)) | (1L << (HexInteger - 76)) | (1L << (DecimalInteger - 76)) | (1L << (OctalInteger - 76)) | (1L << (HexLetter - 76)) | (1L << (ExponentDecimalReal - 76)) | (1L << (RegularDecimalReal - 76)) | (1L << (FILTER - 76)) | (1L << (EXTRACT - 76)) | (1L << (ALLSHORTESTPATHS - 76)) | (1L << (UnescapedSymbolicName - 76)) | (1L << (EscapedSymbolicName - 76)))) != 0)) {
				{
				setState(1179); oC_Expression();
				setState(1181);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1180); match(SP);
					}
				}
				...
				while (_la==T__21) {
					{
					{
					setState(1183); match(T__21);
					setState(1185);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1184); match(SP);
						}
					}

					setState(1187); oC_Expression();
					setState(1189);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1188); match(SP);
						}
					}
	...
	public final OC_PartialComparisonExpressionContext oC_PartialComparisonExpression() throws RecognitionException {
		...
		try {
			...
			case T__32:
				...
				{
				{
				setState(1200); match(T__32);
				setState(1202);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1201); match(SP);
					}
				}

				setState(1204); oC_AddOrSubtractExpression();
				}
				}
				break;
			case T__7:
				...
				{
				{
				setState(1205); match(T__7);
				setState(1207);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1206); match(SP);
					}
				}

				setState(1209); oC_AddOrSubtractExpression();
				}
				}
				break;
			case T__11:
				...
				{
				{
				setState(1210); match(T__11);
				setState(1212);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1211); match(SP);
					}
				}

				setState(1214); oC_AddOrSubtractExpression();
				}
				}
				break;
			case T__8:
				...
				{
				{
				setState(1215); match(T__8);
				setState(1217);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1216); match(SP);
					}
				}

				setState(1219); oC_AddOrSubtractExpression();
				}
				}
				break;
			case T__28:
				...
				{
				{
				setState(1220); match(T__28);
				setState(1222);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1221); match(SP);
					}
				}

				setState(1224); oC_AddOrSubtractExpression();
				}
				}
				break;
			case T__13:
				...
				{
				{
				setState(1225); match(T__13);
				setState(1227);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1226); match(SP);
					}
				}

				setState(1229); oC_AddOrSubtractExpression();
				}
				}
				break;
			default:
	...
	public final OC_ParenthesizedExpressionContext oC_ParenthesizedExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1232); match(T__25);
			setState(1234);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1233); match(SP);
				}
			}

			setState(1236); oC_Expression();
			setState(1238);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1237); match(SP);
				}
			}

			setState(1240); match(T__5);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			do {
				...
				case 1:
					...
					if (_la==SP) {
						{
						setState(1243); match(SP);
						}
					}

					setState(1246); oC_PatternElementChain();
					}
					}
					break;
				default:
	...
	public final OC_FilterExpressionContext oC_FilterExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(1252); match(SP);
					}
				}

				setState(1255); oC_Where();
				}
				break;
			}
			}
	...
	public final OC_IdInCollContext oC_IdInColl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1258); oC_Variable();
			setState(1259); match(SP);
			setState(1260); match(IN);
			setState(1261); match(SP);
			setState(1262); oC_Expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_FunctionInvocationContext oC_FunctionInvocation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1264); oC_FunctionName();
			setState(1266);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1265); match(SP);
				}
			}

			setState(1268); match(T__25);
			setState(1270);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1269); match(SP);
				}
			}
			...
			if (_la==DISTINCT) {
				{
				setState(1272); match(DISTINCT);
				setState(1274);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1273); match(SP);
					}
				}
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__36) | (1L << T__27) | (1L << T__25) | (1L << T__12) | (1L << T__4) | (1L << T__2) | (1L << ALL))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (NOT - 76)) | (1L << (NULL - 76)) | (1L << (COUNT - 76)) | (1L << (ANY - 76)) | (1L << (NONE - 76)) | (1L << (SINGLE - 76)) | (1L << (TRUE - 76)) | (1L << (FALSE - 76)) | (1L << (EXISTS - 76)) | (1L << (CASE - 76)) | (1L << (StringLiteral - 76)) | (1L << (HexInteger - 76)) | (1L << (DecimalInteger - 76)) | (1L << (OctalInteger - 76)) | (1L << (HexLetter - 76)) | (1L << (ExponentDecimalReal - 76)) | (1L << (RegularDecimalReal - 76)) | (1L << (FILTER - 76)) | (1L << (EXTRACT - 76)) | (1L << (ALLSHORTESTPATHS - 76)) | (1L << (UnescapedSymbolicName - 76)) | (1L << (EscapedSymbolicName - 76)))) != 0)) {
				{
				setState(1278); oC_Expression();
				setState(1280);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1279); match(SP);
					}
				}
				...
				while (_la==T__21) {
					{
					{
					setState(1282); match(T__21);
					setState(1284);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1283); match(SP);
						}
					}

					setState(1286); oC_Expression();
					setState(1288);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1287); match(SP);
						}
					}
	...
	public final OC_FunctionNameContext oC_FunctionName() throws RecognitionException {
		...
		try {
			...
			case EscapedSymbolicName:
				...
				{
				{
				setState(1299); oC_Namespace();
				setState(1300); oC_SymbolicName();
				}
				}
				break;
			case EXISTS:
	...
	public final OC_ExplicitProcedureInvocationContext oC_ExplicitProcedureInvocation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1305); oC_ProcedureName();
			setState(1307);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1306); match(SP);
				}
			}

			setState(1309); match(T__25);
			setState(1311);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1310); match(SP);
				}
			}
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__36) | (1L << T__27) | (1L << T__25) | (1L << T__12) | (1L << T__4) | (1L << T__2) | (1L << ALL))) != 0) || ((((_la - 76)) & ~0x3f) == 0 && ((1L << (_la - 76)) & ((1L << (NOT - 76)) | (1L << (NULL - 76)) | (1L << (COUNT - 76)) | (1L << (ANY - 76)) | (1L << (NONE - 76)) | (1L << (SINGLE - 76)) | (1L << (TRUE - 76)) | (1L << (FALSE - 76)) | (1L << (EXISTS - 76)) | (1L << (CASE - 76)) | (1L << (StringLiteral - 76)) | (1L << (HexInteger - 76)) | (1L << (DecimalInteger - 76)) | (1L << (OctalInteger - 76)) | (1L << (HexLetter - 76)) | (1L << (ExponentDecimalReal - 76)) | (1L << (RegularDecimalReal - 76)) | (1L << (FILTER - 76)) | (1L << (EXTRACT - 76)) | (1L << (ALLSHORTESTPATHS - 76)) | (1L << (UnescapedSymbolicName - 76)) | (1L << (EscapedSymbolicName - 76)))) != 0)) {
				{
				setState(1313); oC_Expression();
				setState(1315);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1314); match(SP);
					}
				}
				...
				while (_la==T__21) {
					{
					{
					setState(1317); match(T__21);
					setState(1319);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1318); match(SP);
						}
					}

					setState(1321); oC_Expression();
					setState(1323);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1322); match(SP);
						}
					}
	...
	public final OC_ImplicitProcedureInvocationContext oC_ImplicitProcedureInvocation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1334); oC_ProcedureName();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_ProcedureNameContext oC_ProcedureName() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1338); oC_Namespace();
			setState(1339); oC_SymbolicName();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(1341); oC_SymbolicName();
					setState(1342); match(T__20);
					}
					} 
				}
				setState(1348);
	...
	public final OC_ListComprehensionContext oC_ListComprehension() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1349); match(T__12);
			setState(1351);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1350); match(SP);
				}
			}

			setState(1353); oC_FilterExpression();
			setState(1362);
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(1354); match(SP);
					}
				}

				setState(1357); match(T__10);
				setState(1359);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1358); match(SP);
					}
				}

				setState(1361); oC_Expression();
				}
				break;
			}
			setState(1365);
			...
			if (_la==SP) {
				{
				setState(1364); match(SP);
				}
			}

			setState(1367); match(T__9);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_PatternComprehensionContext oC_PatternComprehension() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1369); match(T__12);
			setState(1371);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1370); match(SP);
				}
			}
			...
			if (((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & ((1L << (COUNT - 83)) | (1L << (ANY - 83)) | (1L << (NONE - 83)) | (1L << (SINGLE - 83)) | (1L << (HexLetter - 83)) | (1L << (FILTER - 83)) | (1L << (EXTRACT - 83)) | (1L << (ALLSHORTESTPATHS - 83)) | (1L << (UnescapedSymbolicName - 83)) | (1L << (EscapedSymbolicName - 83)))) != 0)) {
				{
				setState(1373); oC_Variable();
				setState(1375);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1374); match(SP);
					}
				}

				setState(1377); match(T__32);
				setState(1379);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1378); match(SP);
					}
				}
			...
			setState(1383); oC_RelationshipsPattern();
			setState(1385);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1384); match(SP);
				}
			}
			...
			if (_la==WHERE) {
				{
				setState(1387); match(WHERE);
				setState(1389);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1388); match(SP);
					}
				}

				setState(1391); oC_Expression();
				setState(1393);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1392); match(SP);
					}
				}
			...
			setState(1397); match(T__10);
			setState(1399);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1398); match(SP);
				}
			}

			setState(1401); oC_Expression();
			setState(1403);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1402); match(SP);
				}
			}

			setState(1405); match(T__9);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_PropertyLookupContext oC_PropertyLookup() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1407); match(T__20);
			setState(1409);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1408); match(SP);
				}
			}

			{
			setState(1411); oC_PropertyKeyName();
			}
			}
		}
		catch (RecognitionException re) {
	...
	public final OC_CaseExpressionContext oC_CaseExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				do {
					...
					case 1:
						...
						if (_la==SP) {
							{
							setState(1414); match(SP);
							}
						}

						setState(1417); oC_CaseAlternatives();
						}
						}
						break;
					default:
			...
			case 2:
				{
				{
				setState(1422); match(CASE);
				setState(1424);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1423); match(SP);
					}
				}

				setState(1426); oC_Expression();
				setState(1431); 
				_errHandler.sync(this);
				_alt = 1;
				do {
					...
					case 1:
						...
						if (_la==SP) {
							{
							setState(1427); match(SP);
							}
						}

						setState(1430); oC_CaseAlternatives();
						}
						}
						break;
					default:
			...
			case 1:
				...
				if (_la==SP) {
					{
					setState(1437); match(SP);
					}
				}

				setState(1440); match(ELSE);
				setState(1442);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1441); match(SP);
					}
				}

				setState(1444); oC_Expression();
				}
				break;
			}
			setState(1448);
			...
			if (_la==SP) {
				{
				setState(1447); match(SP);
				}
			}

			setState(1450); match(END);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_CaseAlternativesContext oC_CaseAlternatives() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1452); match(WHEN);
			setState(1454);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1453); match(SP);
				}
			}

			setState(1456); oC_Expression();
			setState(1458);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1457); match(SP);
				}
			}

			setState(1460); match(THEN);
			setState(1462);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1461); match(SP);
				}
			}

			setState(1464); oC_Expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OC_NumberLiteralContext oC_NumberLiteral() throws RecognitionException {
		...
		try {
			...
			case RegularDecimalReal:
				enterOuterAlt(_localctx, 1);
				{
				setState(1468); oC_DoubleLiteral();
				}
				break;
			case HexInteger:
			case DecimalInteger:
			case OctalInteger:
				enterOuterAlt(_localctx, 2);
				{
				setState(1469); oC_IntegerLiteral();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final OC_MapLiteralContext oC_MapLiteral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1472); match(T__36);
			setState(1474);
			_la = _input.LA(1);
			if (_la==SP) {
				{
				setState(1473); match(SP);
				}
			}

			setState(1509);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << UNION) | (1L << ALL) | (1L << OPTIONAL) | (1L << MATCH) | (1L << UNWIND) | (1L << AS) | (1L << MERGE) | (1L << ON) | (1L << CREATE) | (1L << SET) | (1L << DETACH) | (1L << DELETE) | (1L << REMOVE) | (1L << WITH) | (1L << DISTINCT) | (1L << RETURN))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (ORDER - 64)) | (1L << (BY - 64)) | (1L << (L_SKIP - 64)) | (1L << (LIMIT - 64)) | (1L << (ASCENDING - 64)) | (1L << (ASC - 64)) | (1L << (DESCENDING - 64)) | (1L << (DESC - 64)) | (1L << (WHERE - 64)) | (1L << (OR - 64)) | (1L << (XOR - 64)) | (1L << (AND - 64)) | (1L << (NOT - 64)) | (1L << (IN - 64)) | (1L << (STARTS - 64)) | (1L << (ENDS - 64)) | (1L << (CONTAINS - 64)) | (1L << (IS - 64)) | (1L << (NULL - 64)) | (1L << (COUNT - 64)) | (1L << (ANY - 64)) | (1L << (NONE - 64)) | (1L << (SINGLE - 64)) | (1L << (TRUE - 64)) | (1L << (FALSE - 64)) | (1L << (EXISTS - 64)) | (1L << (CASE - 64)) | (1L << (ELSE - 64)) | (1L << (END - 64)) | (1L << (WHEN - 64)) | (1L << (THEN - 64)) | (1L << (HexLetter - 64)) | (1L << (CONSTRAINT - 64)) | (1L << (DO - 64)) | (1L << (FOR - 64)) | (1L << (REQUIRE - 64)) | (1L << (UNIQUE - 64)) | (1L << (MANDATORY - 64)) | (1L << (SCALAR - 64)) | (1L << (OF - 64)) | (1L << (ADD - 64)) | (1L << (DROP - 64)) | (1L << (FILTER - 64)) | (1L << (EXTRACT - 64)) | (1L << (ALLSHORTESTPATHS - 64)) | (1L << (UnescapedSymbolicName - 64)) | (1L << (EscapedSymbolicName - 64)))) != 0)) {
				{
				setState(1476); oC_PropertyKeyName();
				setState(1478);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1477); match(SP);
					}
				}

				setState(1480); match(T__14);
				setState(1482);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1481); match(SP);
					}
				}

				setState(1484); oC_Expression();
				setState(1486);
				_la = _input.LA(1);
				if (_la==SP) {
					{
					setState(1485); match(SP);
					}
				}
				...
				while (_la==T__21) {
					{
					{
					setState(1488); match(T__21);
					setState(1490);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1489); match(SP);
						}
					}

					setState(1492); oC_PropertyKeyName();
					setState(1494);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1493); match(SP);
						}
					}

					setState(1496); match(T__14);
					setState(1498);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1497); match(SP);
						}
					}

					setState(1500); oC_Expression();
					setState(1502);
					_la = _input.LA(1);
					if (_la==SP) {
						{
						setState(1501); match(SP);
						}
					}
	...
	public final OC_ParameterContext oC_Parameter() throws RecognitionException {
		...
		try {
			...
			case EscapedSymbolicName:
				{
				setState(1514); oC_SymbolicName();
				}
				break;
			case DecimalInteger:
				{
				setState(1515); match(DecimalInteger);
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			do {
				...
				case 1:
					...
					if (_la==SP) {
						{
						setState(1519); match(SP);
						}
					}

					setState(1522); oC_PropertyLookup();
					}
					}
					break;
				default:
	...
	public final OC_LeftArrowHeadContext oC_LeftArrowHead() throws RecognitionException {
		...
		try {
			...
			setState(1541);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__37) | (1L << T__29) | (1L << T__22) | (1L << T__11) | (1L << T__0))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final OC_RightArrowHeadContext oC_RightArrowHead() throws RecognitionException {
		...
		try {
			...
			setState(1543);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__30) | (1L << T__23) | (1L << T__16) | (1L << T__8) | (1L << T__1))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final OC_DashContext oC_Dash() throws RecognitionException {
		...
		try {
			...
			setState(1545);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__43) | (1L << T__42) | (1L << T__40) | (1L << T__39) | (1L << T__38) | (1L << T__26) | (1L << T__19) | (1L << T__18) | (1L << T__17) | (1L << T__15) | (1L << T__3) | (1L << T__2))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public static final String _serializedATN =
		...
		"\u0088\u008a\u008c\u008e\u0090\u0092\u0094\u0096\u0098\u009a\u009c\u009e"+
		"\u00a0\u00a2\u00a4\u00a6\u00a8\u00aa\u00ac\u00ae\u00b0\u00b2\u00b4\u00b6"+
		"\u00b8\u00ba\u00bc\u00be\u00c0\u00c2\u00c4\u00c6\2\f\3\2FI\4\2++--\3\2"+
		"YZ\3\2ce\3\2mn\6\2\60<?TY`ox\6\2UXffy|\177\177\7\2\n\n\22\22\31\31$$/"+
		"/\7\2\21\21\30\30\37\37\'\'..\b\2\4\5\7\t\25\25\34\36  ,-\u06e7\2\u00c9"+
